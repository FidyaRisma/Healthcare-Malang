...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [112.535235, -8.121126, 112.874192, -7.927608], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([112.535235, -8.121126, 112.874192, -7.927608], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Healthcare Density in Malang Municipality</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (105 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Shows hospitals and clinics in Malang Municipality and their distribution density based on Kernel Density';
            }
