var size = 0;
var placement = 'point';
function categories_RoadClass_2(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'primary':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(229,0,4,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 4.028}),
...
case 'secondary':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(255,255,255,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 6.308}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    }),new ol.style.Style({
...
var style_RoadClass_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_RoadClass_2(feature, value, size, resolution, labelText,
